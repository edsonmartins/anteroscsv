 ...
 */
public class AnterosCSVIterator implements Iterator<String[]> {
   private final AnterosCSVReader reader;
    ...
    */
   public AnterosCSVIterator(AnterosCSVReader reader) throws IOException {
      this.reader = reader;
