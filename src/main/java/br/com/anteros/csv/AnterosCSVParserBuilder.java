...
public class AnterosCSVParserBuilder {
     ...
     * Default constructor.
     */
    public AnterosCSVParserBuilder() {
    }
     ...
     */
    public AnterosCSVParserBuilder withSeparator(
     ...
     * @return The CSVParserBuilder
     */
    public AnterosCSVParserBuilder withQuoteChar(
     ...
     * @return The CSVParserBuilder
     */
    public AnterosCSVParserBuilder withEscapeChar(
     ...
     * @return The CSVParserBuilder
     */
    public AnterosCSVParserBuilder withStrictQuotes(
     ...
     * @return The CSVParserBuilder
     */
    public AnterosCSVParserBuilder withIgnoreLeadingWhiteSpace(
     ...
     * @return The CSVParserBuilder
     */
    public AnterosCSVParserBuilder withIgnoreQuotations(
    ...
    public AnterosCSVParser build() {
        ...
        AnterosCSVParser parser = new AnterosCSVParser(
                separator,
                quoteChar,
                escapeChar,
                strictQuotes,
     ...
     * @return The CSVParserBuilder
     */
    public AnterosCSVParserBuilder withFieldAsNull(final CSVReaderNullFieldIndicator fieldIndicator) {
