...
import br.com.anteros.csv.AnterosCSVReaderBuilder;
...
public class CsvToBeanBuilder<T> {
   ...
   /** @see br.com.anteros.csv.AnterosCSVParser#nullFieldIndicator */
   private CSVReaderNullFieldIndicator nullFieldIndicator = null;
   
   /** @see br.com.anteros.csv.AnterosCSVReader#keepCR */
   private boolean keepCR;
   
   /** @see br.com.anteros.csv.AnterosCSVReader#skipLines */
   private Integer skipLines = null;
   
   /** @see br.com.anteros.csv.AnterosCSVReader#verifyReader */
   private Boolean verifyReader = null;
   
   /** @see br.com.anteros.csv.AnterosCSVParser#separator */
   private Character separator = null;
   
   /** @see br.com.anteros.csv.AnterosCSVParser#quotechar */
   private Character quoteChar = null;
   
   /** @see br.com.anteros.csv.AnterosCSVParser#escape */
   private Character escapeChar = null;
   
   /** @see br.com.anteros.csv.AnterosCSVParser#strictQuotes */
   private Boolean strictQuotes = null;
   
   /** @see br.com.anteros.csv.AnterosCSVParser#ignoreLeadingWhiteSpace */
   private Boolean ignoreLeadingWhiteSpace = null;
   
   /** @see br.com.anteros.csv.AnterosCSVParser#ignoreQuotations */
   private Boolean ignoreQuotations = null;

   /** @see HeaderColumnNameMappingStrategy#type */
   private Class<? extends T> type = null;
   
   /** @see br.com.anteros.csv.AnterosCSVReader#multilineLimit */
   private Integer multilineLimit = null;
   
   /** @see br.com.anteros.csv.bean.CsvToBean#orderedResults */
   private boolean orderedResults = true;
   
   /** @see br.com.anteros.csv.bean.CsvToBean#errorLocale */
   ...
   public CsvToBeanBuilder(Reader reader) {
    ...
    public CsvToBean<T> build() throws IllegalStateException {
        ...
        AnterosCSVParser parser = buildParser();
    ...
    /**
     * Builds a {@link AnterosCSVParser} from the information provided to this builder.
     * This is an intermediate step in building the {@link CsvToBean}.
     * @return An appropriate {@link AnterosCSVParser}
     */
    private AnterosCSVParser buildParser() {
        AnterosCSVParserBuilder csvpb = new AnterosCSVParserBuilder();
    ...
    /**
     * Builds a {@link AnterosCSVReader} from the information provided to this builder.
     * This is an intermediate step in building the {@link CsvToBean}.
     * @param parser The {@link AnterosCSVParser} necessary for this reader
     * @return An appropriate {@link AnterosCSVReader}
     */
    private AnterosCSVReader buildReader(AnterosCSVParser parser) {
        AnterosCSVReaderBuilder csvrb = new AnterosCSVReaderBuilder(reader);
    ...
    /**
     * @see CsvToBean#setMappingStrategy(br.com.anteros.csv.bean.MappingStrategy)
    ...
    /**
     * @see CsvToBean#setFilter(br.com.anteros.csv.bean.CsvToBeanFilter)
    ...
    /**
     * @see AnterosCSVParser#CSVParser(char, char, char, boolean, boolean, boolean, CSVReaderNullFieldIndicator)
    ...
    /**
     * @see AnterosCSVReader#CSVReader(java.io.Reader, char, char, char, int, boolean, boolean, boolean)
    ...
    /**
     * @see AnterosCSVReaderBuilder#withVerifyReader(boolean) 
    ...
    /**
     * @see AnterosCSVReaderBuilder#withSkipLines(int) 
    ...
    /**
     * @see AnterosCSVParser#CSVParser(char)
    ...
    /**
     * @see AnterosCSVParser#CSVParser(char, char)
    ...
    /**
     * @see AnterosCSVParser#CSVParser(char, char, char)
    ...
    /**
     * @see AnterosCSVParser#CSVParser(char, char, char, boolean)
    ...
    /**
     * @see AnterosCSVParser#CSVParser(char, char, char, boolean, boolean)
    ...
    /**
     * @see AnterosCSVParser#CSVParser(char, char, char, boolean, boolean, boolean)
     ...
     * Ignored if {@link #withMappingStrategy(br.com.anteros.csv.bean.MappingStrategy)}
     * is called.
